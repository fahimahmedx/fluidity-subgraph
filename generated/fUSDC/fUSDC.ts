...
export class fUSDC__getUtilityVarsResultValue0Struct extends ethereum.Tuple {
...
export class fUSDC extends ethereum.SmartContract {
  static bind(address: Address): fUSDC {
    return new fUSDC("fUSDC", address);
  }
  ...
  getUtilityVars(): fUSDC__getUtilityVarsResultValue0Struct {
    let result = super.call(
      "getUtilityVars",
    ...
    return changetype<fUSDC__getUtilityVarsResultValue0Struct>(
      result[0].toTuple()
    );
  }

  try_getUtilityVars(): ethereum.CallResult<
    fUSDC__getUtilityVarsResultValue0Struct
  > {
    let result = super.tryCall(
      "getUtilityVars",
      "getUtilityVars():((uint256,uint256,uint256,uint256,uint256,uint256))",
    ...
    return ethereum.CallResult.fromValue(
      changetype<fUSDC__getUtilityVarsResultValue0Struct>(value[0].toTuple())
    );
  }

...
export class fDAI__getUtilityVarsResultValue0Struct extends ethereum.Tuple {
...
export class fDAI extends ethereum.SmartContract {
  static bind(address: Address): fDAI {
    return new fDAI("fDAI", address);
  }
  ...
  getUtilityVars(): fDAI__getUtilityVarsResultValue0Struct {
    let result = super.call(
      "getUtilityVars",
    ...
    return changetype<fDAI__getUtilityVarsResultValue0Struct>(
      result[0].toTuple()
    );
  }

  try_getUtilityVars(): ethereum.CallResult<
    fDAI__getUtilityVarsResultValue0Struct
  > {
    let result = super.tryCall(
      "getUtilityVars",
      "getUtilityVars():((uint256,uint256,uint256,uint256,uint256,uint256))",
    ...
    return ethereum.CallResult.fromValue(
      changetype<fDAI__getUtilityVarsResultValue0Struct>(value[0].toTuple())
    );
  }

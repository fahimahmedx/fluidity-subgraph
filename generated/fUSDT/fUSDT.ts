...
export class fUSDT__getUtilityVarsResultValue0Struct extends ethereum.Tuple {
...
export class fUSDT extends ethereum.SmartContract {
  static bind(address: Address): fUSDT {
    return new fUSDT("fUSDT", address);
  }
  ...
  getUtilityVars(): fUSDT__getUtilityVarsResultValue0Struct {
    let result = super.call(
      "getUtilityVars",
    ...
    return changetype<fUSDT__getUtilityVarsResultValue0Struct>(
      result[0].toTuple()
    );
  }

  try_getUtilityVars(): ethereum.CallResult<
    fUSDT__getUtilityVarsResultValue0Struct
  > {
    let result = super.tryCall(
      "getUtilityVars",
      "getUtilityVars():((uint256,uint256,uint256,uint256,uint256,uint256))",
    ...
    return ethereum.CallResult.fromValue(
      changetype<fUSDT__getUtilityVarsResultValue0Struct>(value[0].toTuple())
    );
  }

...
export class fFRAX__getUtilityVarsResultValue0Struct extends ethereum.Tuple {
...
export class fFRAX extends ethereum.SmartContract {
  static bind(address: Address): fFRAX {
    return new fFRAX("fFRAX", address);
  }
  ...
  getUtilityVars(): fFRAX__getUtilityVarsResultValue0Struct {
    let result = super.call(
      "getUtilityVars",
    ...
    return changetype<fFRAX__getUtilityVarsResultValue0Struct>(
      result[0].toTuple()
    );
  }

  try_getUtilityVars(): ethereum.CallResult<
    fFRAX__getUtilityVarsResultValue0Struct
  > {
    let result = super.tryCall(
      "getUtilityVars",
      "getUtilityVars():((uint256,uint256,uint256,uint256,uint256,uint256))",
    ...
    return ethereum.CallResult.fromValue(
      changetype<fFRAX__getUtilityVarsResultValue0Struct>(value[0].toTuple())
    );
  }
